...
extern "C"
{
     ...
     * @param sourceRect The portion of the texture to draw as an image. Negative values for the width and height will
     * flip the image
     */
    void rligImageRect(const Texture *image, int destWidth, int destHeight, Rectangle sourceRect);

    /**
     * Draws a render texture as an image an ImGui Context, automatically flipping the Y axis so it will show correctly
     * on screen
     *
    ...
    /**
     * Draws a render texture as an image an ImGui Context, automatically flipping the Y axis so it will show correctly
     * on screen Fits the render texture to the available content area
     *
     * @param image The render texture to draw
    ...
    /**
     * Draws a texture as an image button in an ImGui context. Uses the current ImGui cursor position and the full size
     * of the texture
     *
